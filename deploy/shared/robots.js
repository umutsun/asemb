...
exports.isAllowedByRobots = isAllowedByRobots;
...
async function isAllowedByRobots(urlStr) {
    try {
        ...
        if (!res.ok)
            return true; // be lenient if robots not reachable
...
function evaluateRobots(robotsTxt, path) {
