...
exports.AliceSemanticBridgeApi = void 0;
class AliceSemanticBridgeApi {
    constructor() {
        this.name = 'aliceSemanticBridgeApi';
        this.displayName = 'Alice Semantic Bridge API';
        this.documentationUrl = 'https://github.com/alice-semantic-bridge/docs';
        this.properties = [
            {
...
exports.AliceSemanticBridgeApi = AliceSemanticBridgeApi;
