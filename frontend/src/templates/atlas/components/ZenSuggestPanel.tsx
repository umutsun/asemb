 ...
 * Popover card above the input: surface bg, border, 12px radius, large shadow.
 */
      ...
      <div className="atlas-panel-list">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-6">
            <Loader2 className="h-5 w-5 animate-spin text-[var(--atlas-muted)]" />
            <span className="mt-2 text-xs text-[var(--atlas-muted)]">{t('chat.loadingSuggestions', 'Loading suggestions...')}</span>
          </div>
