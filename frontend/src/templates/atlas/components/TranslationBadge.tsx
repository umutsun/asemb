...
export const TranslationBadge: React.FC<TranslationBadgeProps> = ({
  ...
  return (
    <button
      type="button"
      onClick={onToggle}
      className={`inline-flex items-center gap-1 rounded px-1.5 py-1 text-[10px] font-medium uppercase tracking-wide transition-colors hover:bg-[var(--atlas-surface-2)] ${
        isShowingTranslation
