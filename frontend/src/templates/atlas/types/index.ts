...
export interface ZenMessage {
  ...
  /** Structured answer payload — when present it is rendered deterministically
   *  (see StructuredAnswerBody) instead of Markdown. Absent on legacy / non-structured messages. */
