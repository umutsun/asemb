...
export const ZenHistoryPanel: React.FC<ZenHistoryPanelProps> = ({
  ...
  return (
    <div ref={panelRef} className="majlis-panel majlis-msg-in">
      ...
      {/* Conversations List */}
      <ScrollArea className="majlis-panel-list">
        {isLoading ? (
          <div className="py-1">
            <div className="majlis-panel-skeleton" />
            <div className="majlis-panel-skeleton" />
            <div className="majlis-panel-skeleton" />
          </div>
          ...
          groupedConversations.map(([group, convs]) => (
            <div key={group}>
              <div className="majlis-panel-label">{group}</div>
              {convs.map(conv => (
                <div
                  key={conv.id}
                  onClick={() => {
                ...
                >
                  <span className="majlis-history-item-title">
                    {conv.title || 'Untitled conversation'}
                  </span>
                  <span className="majlis-history-item-time">
                  ...
                  {confirmDeleteId === conv.id ? (
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="majlis-history-confirm-yes"
                      >
                        Delete
                      </button>
                      <button
                        ...
                        className="majlis-history-confirm-no"
                    ...
                    <button
                      type="button"
                      onClick={(e) => handleDeleteClick(e, conv.id)}
                      className="majlis-history-item-delete"
                      title="Delete"
                    >
