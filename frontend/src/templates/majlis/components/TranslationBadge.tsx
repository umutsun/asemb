 ...
 * the copy/TTS ghost buttons: muted, hover brass); brass when the translation
 * is being shown. Colors come from container-scoped tokens.
 */
export const TranslationBadge: React.FC<TranslationBadgeProps> = ({
  ...
  return (
    <button
      type="button"
      onClick={onToggle}
      className={`inline-flex items-center gap-1 rounded-sm px-1.5 py-1 text-[10px] font-medium uppercase tracking-wide transition-colors ${
        isShowingTranslation
