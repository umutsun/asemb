      ...
      <div className="counsel-panel-list">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-6">
            <Loader2 className="h-5 w-5 animate-spin text-[var(--counsel-muted)]" />
            <span className="mt-2 text-xs text-[var(--counsel-muted)]">{t('chat.loadingSuggestions', 'Loading suggestions...')}</span>
          </div>
